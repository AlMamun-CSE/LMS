package com.techdsf.lms.Models;
...
public class Courses implements Serializable {
    ...
    public Courses(int id, String title, String thumbnail, String price, String instructor, float rating, int totalNumberRating, int numberOfEnrollment, String shareableLink, String courseOverviewProvider, String courseOverviewUrl) {
        this.id = id;
        this.title = title;
    ...
    public Courses(int id, String title, String thumbnail, String price, float rating) {
        this.id = id;
        this.title = title;
        this.thumbnail = thumbnail;
        this.price = price;
